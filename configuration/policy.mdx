...
<Note>
  `--policy` takes precedence over `--calibrated` for routing resolution. See [Calibration Quick Start](/configuration/policy#calibrated-routing) for flag precedence details.
</Note>
