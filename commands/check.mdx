...
<ParamField path="-d, --detailed" type="flag">
...
<ParamField path="--ollama-only" type="flag">
  Only show models that are available in the Ollama registry.
</ParamField>

<ParamField path="--performance-test" type="flag">
...
<ParamField path="--show-ollama-analysis" type="flag">
